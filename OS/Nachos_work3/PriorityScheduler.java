	 ...
	 */
		...
		public KThread nextThread() {
			...
			if (transferPriority && threadState != null) {           
				...
				threadState.addQueue(this);                          // 현재 상태의 priorityQueue 를 Donation Queue 리스트에 append (라애에 정의된 addQueue 메소드 사용할 것)
			}
		...
		public boolean transferPriority;     // 우선순위 양도가 가능한지 여부를 나타내는 상태 변수(public boolean 변수) 정의
	}
	// ------------------------------------------------------------------------------------------------------------
